...
Read Me — methodology, maturity scale, and document control
Maturity Assessment — all 22 Categories with Current/Target scores, gap, priority, evidence, recommended action, owner, and target quarter
Function Summary — average Current and Target maturity per Function, with a comparison chart
Roadmap — the same 22 actions, resequenced by target quarter and priority
Limitations
